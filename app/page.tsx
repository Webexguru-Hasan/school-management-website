      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-2 flex flex-col gap-1">
            <Link href="/admission" className="flex items-center px-4 py-3 rounded-xl hover:bg-slate-50 transition-colors">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mr-3">
                ➕
              </span>
              <span className="font-medium text-slate-700">New Admission</span>
              <span className="ml-auto text-slate-400">→</span>
            </Link>
            <Link href="/attendance" className="flex items-center px-4 py-3 rounded-xl hover:bg-slate-50 transition-colors">
            ...
            <Link href="/fees" className="flex items-center px-4 py-3 rounded-xl hover:bg-slate-50 transition-colors">
              <span className="w-8 h-8 rounded-lg bg-amber-50 text-amber-600 flex items-center justify-center mr-3">
                💰
              </span>
              <span className="font-medium text-slate-700">Collect Fee</span>
              <span className="ml-auto text-slate-400">→</span>
            </Link>
          </div>
        </div>
